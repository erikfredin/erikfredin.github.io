...
📸 Screenshot:  
![Project Screenshot](./assets/project2.png)

🎥 Demo (GIF):  
![Demo GIF](./assets/project2-demo.gif)
...
You can showcase visuals separately too:

![Screenshot 1](./assets/gallery1.png)  
![Screenshot 2](./assets/gallery2.png)  
![GIF Demo](./assets/gallery-demo.gif)
...
- Built X feature that improved Y  
- Worked with Z technologies  
